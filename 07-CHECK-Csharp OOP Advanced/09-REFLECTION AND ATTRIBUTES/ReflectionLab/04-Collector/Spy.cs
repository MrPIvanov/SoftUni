...
public class Spy
{
    ...
    public string CollectGettersAndSetters(string classToInvestigate)
    {
        ...
        var type = Type.GetType(classToInvestigate);
        var getters = type.GetMethods(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic)
            .Where(g => g.Name.StartsWith("get")).ToArray();
        var setters = type.GetMethods(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic)
            .Where(g => g.Name.StartsWith("set")).ToArray();
