function validate() {
    ...
    function GenerateEGN() {
        ...
        let isRegionCodeInvalid = regionalCode < 43 || regionalCode > 999 || regionalCode.trim() === '';

        if (isYearInvalid || isRegionCodeInvalid) {
            return;
        }
        ...
        let remainder = calculateRemainder(EGN) > 9 ? 0 : calculateRemainder(EGN);
        EGN += remainder;
