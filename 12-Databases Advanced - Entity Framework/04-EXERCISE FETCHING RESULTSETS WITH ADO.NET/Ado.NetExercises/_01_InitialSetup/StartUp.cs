    ...
    public class StartUp
    {
        public static void Main()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                ExecNonQueryCommand(createDatabaseSql, connection);
                ...
                ExecNonQueryCommand(createCountriesSQL, connection);
                ExecNonQueryCommand(createTownsSQL, connection);
                ExecNonQueryCommand(createMinionsSQL, connection);
                ExecNonQueryCommand(createEvilnessFactorsSQL, connection);
                ExecNonQueryCommand(createVillainsSQL, connection);
                ExecNonQueryCommand(createMinionsVillainsSQL, connection);

                ExecNonQueryCommand(insertCountriesSQL, connection);
                ExecNonQueryCommand(insertTownsSQL, connection);
                ExecNonQueryCommand(insertMinionsSQL, connection);
                ExecNonQueryCommand(insertEvilnessFactorsSQL, connection);
                ExecNonQueryCommand(insertVillainsSQL, connection);
                ExecNonQueryCommand(insertMinionsVillainsSQL, connection);
        ...
        private static void ExecNonQueryCommand(string sqlString, SqlConnection connection)
        {
